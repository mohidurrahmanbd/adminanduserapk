...
import { 
  isJobSolutionVariation, 
  isYearJobSolutionVariation, 
  isCurrentAffairVariation 
} from '../shared/lib/routineUtils';
export { isCurrentAffairVariation };

export default function AdminOnlyApp() {
  // Database States
  ...
  const [authScreen, setAuthScreen] = useState<'admin-login' | 'forgot-password'>('admin-login'); // Standalone Admin default
  const [_unusedAuthScreen, _setUnusedAuthScreen] = useState<any>(() => {
  ...
  return (
    <div className="min-h-screen max-w-full overflow-x-hidden bg-slate-50 text-slate-800 antialiased font-sans flex flex-col justify-between relative">
      ...
      <div className="w-full max-w-5xl mx-auto p-1 sm:p-2 md:p-2.5 flex-grow flex flex-col overflow-x-hidden">
        ...
        {/* LOGGED IN USER VIEW */}
        {/* UserApp excluded from Admin build */}
